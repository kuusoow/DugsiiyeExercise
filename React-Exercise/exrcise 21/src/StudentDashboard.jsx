...
function StudentDashboard() {
  ...
  const courses = [
    { id: 1, name: 'React Fundamentals', progress: 75, instructor: 'mr Hamouda', nextLesson: 'Components & Props', color: 'blue' },
    { id: 2, name: 'JavaScript Advanced', progress: 45, instructor: 'mr Omar Tod', nextLesson: 'Async/Await', color: 'purple' },
    { id: 3, name: 'Node.js && Express', progress: 90, instructor: 'mr sharfdiin', nextLesson: 'senitization', color: 'pink' },
  ];

  const assignments = [
    { id: 1, title: 'Build a Todo App', course: 'React Fundamentals', dueDate: '2026-09-20', status: 'pending' },
    { id: 2, title: 'API Integration', course: 'JavaScript Advanced', dueDate: '2025-12-18', status: 'completed' },
    { id: 3, title: 'full stack project', course: 'Node.js && Express', dueDate: '2026-09-14', status: 'in-progress' },
  ];
